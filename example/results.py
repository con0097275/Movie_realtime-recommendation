...
# with driver.session() as session:
#     # Run the unit of work within a Read Transaction
#     actors = session.read_transaction(get_actors_iterate, movie="The Green Mile") # <2>
...
# with driver.session() as session:
#     # Run the unit of work within a Read Transaction
#     actors = session.write_transaction(get_actors_consume, name="VAN DZ") # <2>
#     print(actors)
...
# with driver.session() as session:
#     # Run the unit of work within a Read Transaction
#     actors = session.read_transaction(get_actors_peek, movie="The Green Mile") # <2>
#     print(actors)
"""
...
# with driver.session() as session:
#     # Run the unit of work within a Read Transaction
#     actors = session.read_transaction(get_actors_graph, movie="The Green Mile") # <2>
#     print(actors)
...
# with driver.session() as session:
#     # Run the unit of work within a Read Transaction
#     actors = session.read_transaction(get_actors_values, movie="The Green Mile") # <2>
#     print(actors)
"""
...
# with driver.session() as session:
#     # Run the unit of work within a Read Transaction
#     actors = session.read_transaction(get_actors_data, movie="The Green Mile") # <2>
#     print(actors)
